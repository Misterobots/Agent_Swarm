...
MODELS: dict[str, ModelSpec] = {
    ...
    "qwen3.6:27b": ModelSpec(
        ...
        capabilities=["text", "vision", "code", "reasoning"],
        roles=_ALL_ROLES,
        recommended_for_roles=["coordinator", "researcher"],
        description="Qwen 3.6 27B — hybrid attention, 256K ctx, vision. General default.",
    ...
    "deepseek-r1:32b": ModelSpec(
        ...
        roles=["coordinator", "architect", "researcher", "analyst", "verifier"],
        recommended_for_roles=["verifier"],
        description="DeepSeek-R1 32B — dedicated long-CoT reasoning; strong for verify/architecture.",
        alternatives=["gemma4:31b", "qwen3:14b"],
        available=True,
    ),
    "qwen3-coder:30b": ModelSpec(
        ...
        roles=["coder", "architect", "devops"],
        recommended_for_roles=["coder", "devops"],
        description="Qwen 3 Coder 30B — best local code generation; coder/devops default.",
        alternatives=["qwen2.5-coder:14b", "qwen3:14b"],
        available=True,
    ),
    "qwen3:14b": ModelSpec(
        name="qwen3:14b",
    ...
    "phi4-reasoning:14b": ModelSpec(
        name="phi4-reasoning:14b",
        vram_gb=11.1,
        capabilities=["text", "reasoning"],
        roles=["researcher", "analyst", "verifier"],
        recommended_for_roles=[],
        description="Phi-4 Reasoning 14B — compact reasoning; fits alongside a large model.",
        alternatives=["qwen3:14b", "deepseek-r1:32b"],
        available=True,
    ),
    ...
    "minicpm-v:latest": ModelSpec(
        name="minicpm-v:latest",
        vram_gb=5.5,
        capabilities=["vision", "text"],
        roles=[],    # internal: vision/design-mode only
        recommended_for_roles=[],
        description="MiniCPM-V — multimodal vision (internal, not user-selectable)",
        alternatives=[],
        available=True,
    ),
}
