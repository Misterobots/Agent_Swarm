"""Owner-scoped durable lifecycle metadata for isolated task workspaces."""
    ...
    with _db() as conn:
        with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
            cur.execute("""
                ...
                WHERE worktree_id=%s AND owner_id=%s RETURNING *
