...
Execution remains owned by the original substrate. This module deliberately
does not invoke tools; callers must pass its checks and then persist results
...
SANDBOX_TOOLS = frozenset({"read_file", "write_file", "list_directory", "run_command", "edit_file", "glob", "grep", "git"})
