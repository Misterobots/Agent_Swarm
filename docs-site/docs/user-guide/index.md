...
| **Goals Mode** | Per-thread task tracking with plan steps and evidence | [Goals Mode](goals.md) |
| **Plan & Think Modes** | Cognitive-enhancement toggles for decomposition and reasoning | [Plan & Think](plan-think.md) |
