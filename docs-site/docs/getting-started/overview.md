...
Natural language control of Home Assistant devices. Ask the system to turn on lights, check sensor readings, or manage automations. Hardware prototyping is supported through Wokwi ESP32/Arduino simulation, and physical devices can be flashed directly via ESPHome.
