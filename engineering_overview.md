...
*   **Connectivity**: Static IP (`192.168.1.211`)

### Execution Plane (The Body)
*   **Hardware**: Custom Workstation (Dual GPU)
    *   *GPU 1*: RTX 4060 Ti (16GB) - Primary Inference (Qwen2.5-Coder)
    *   *GPU 2*: RTX 3070 Ti (8GB) - Security & Validation (Llama-Guard)
...
1.  **Router (Middleware)**:
    ...
    *   Enforces security scans *before* delegation.
