...
- [ ] **`-Justin-PC` fork file sprawl + worktree sprawl** — triaged 2026-08-27 and documented in `docs/procedures/justin-pc-variant-disposition.md`: 28 tracked variants were compared with their canonical counterparts; 7 are byte-identical after CRLF normalization and 21 diverge. Git registers 8 worktrees, including one dirty `main` worktree with unrelated user changes. No files or worktrees were deleted or merged without dedicated owner review.
