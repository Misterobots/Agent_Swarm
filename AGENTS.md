...
- [ ] **`-Justin-PC` fork file sprawl + worktree sprawl** — triaged 2026-08-27 and documented in `docs/procedures/justin-pc-variant-disposition.md`: 28 tracked variants were audited, and the 7 byte-identical copies were removed after a tracked-reference check; 21 divergent variants remain. Git registers 8 worktrees, including one dirty `main` worktree with unrelated user changes. Divergent variants and worktrees remain subject to owner review.
