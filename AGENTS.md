...
- [ ] **`-Justin-PC` fork file sprawl + worktree sprawl** — triaged 2026-08-27 and documented in `docs/procedures/justin-pc-variant-disposition.md`: 28 tracked variants were audited; 18 obsolete suffixed copies were removed after tracked-reference checks, leaving 10 divergent variants. Git registers 8 worktrees, including one dirty `main` worktree with unrelated user changes. The remaining variants and worktrees remain subject to owner review.
