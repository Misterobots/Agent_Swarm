...
echo "  Location: ~/r730_gateway/config/loki/loki.yml"
...
echo "  • Storage is allocated on R730 (/tmp/loki)"
...
echo "GPU Configuration for Justin-PC (RTX 5060 Ti - 16GB VRAM):"
echo ""
...
echo "  WebUI:   http://192.168.2.103/comfy (via R730 Traefik)"
echo "  API:     ws://localhost:8188/ws"
echo ""
echo "BMO Voice (RVC Inference):"
echo "  Local:   http://localhost:8100"
echo "  Gateway: http://192.168.2.103/bmo (via R730 Traefik)"
echo ""
echo "Voice Engine (TTS):"
echo "  Local:   http://localhost:8020"
echo "  Gateway: http://192.168.2.103/voice (via R730 Traefik)"
echo ""
echo ""
...
echo "  Gateway: http://192.168.2.103/ai (via R730 Traefik)"
echo ""
echo "Ops Portal (Admin Dashboard):"
echo "  Local:   http://localhost:8502"
echo "  Gateway: http://192.168.2.103/ops (via R730 Traefik)"
echo ""
echo "OpenHands (Execution Sandbox):"
echo "  Local:   http://localhost:3000"
echo "  Gateway: http://192.168.2.103/hands (via R730 Traefik)"
echo ""
echo ""
echo "=== DEVELOPMENT ENVIRONMENTS ==="
echo "VS Code (DevOps - Full Access):"
echo "  Local:   https://localhost:8443"
echo "  Gateway: http://192.168.2.103/devops (via R730 Traefik)"
echo "  Scope:   Full workspace access"
echo ""
echo "VS Code (Coding - Restricted):"
echo "  Local:   https://localhost:8444"
echo "  Gateway: http://192.168.2.103/code (via R730 Traefik)"
...
echo "  Outpost: Integrated with Traefik on R730"
echo "  Default: admin / admin (CHANGE IMMEDIATELY)"
echo ""
echo ""
echo "=== MONITORING STACK (R730) ==="
...
echo "  Running on: R730"
echo "  Scrapes:    Docker logs from both nodes"
echo "  Exports:    → Loki on R730"
echo ""
...
echo ""
echo "External Access (via R730 Traefik):"
echo "  ┌─────────────────────────────────────────┐"
...
echo "  • Monitoring and logging consolidated on R730"
...
echo "  3. Create Grafana dashboards for Justin-PC metrics"
