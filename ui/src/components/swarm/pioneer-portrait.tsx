 ...
 * Unlike the old role-keyed silhouettes, these are fixed-color "photo ID"
 * portraits on a light background — the role accent lives on the card frame
 * (border + foil stripe), not the portrait. A role→primary fallback keeps
 * role-only callers (and unnamed perspective workers) rendering a real face.
 *
...
const BY_NAME: Record<string, React.ReactElement> = {
  ...
  shannon: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 37 q4 -2 8 0" stroke="#3a2c20" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M42 37 q4 -2 8 0" stroke="#3a2c20" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="33" cy="43" r="7" fill="none" stroke="#23262f" strokeWidth="2" />
      <circle cx="47" cy="43" r="7" fill="none" stroke="#23262f" strokeWidth="2" />
      <path d="M39 43 h2" stroke="#23262f" strokeWidth="2" />
      <path d="M26 43 L20 42" stroke="#23262f" strokeWidth="1.6" />
      <path d="M54 43 L60 42" stroke="#23262f" strokeWidth="1.6" />
      <circle cx="33" cy="43.5" r="1.6" fill="#2b2622" />
      <circle cx="47" cy="43.5" r="1.6" fill="#2b2622" />
      <path d="M40 44 L40 50 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
  ...
  minsky: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M27 40 q4 -2 7 0" stroke="#7c776e" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M46 40 q4 -2 7 0" stroke="#7c776e" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <rect x="25" y="40" width="15" height="11" rx="2" fill="none" stroke="#2b2622" strokeWidth="2" />
      <rect x="40" y="40" width="15" height="11" rx="2" fill="none" stroke="#2b2622" strokeWidth="2" />
      <circle cx="32" cy="45.5" r="1.6" fill="#2b2622" />
      <circle cx="48" cy="45.5" r="1.6" fill="#2b2622" />
      <path d="M40 47 L40 52 q0 1.2 -2 1.5" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M35 56 q5 -2 10 0" stroke="#a9603f" strokeWidth="1.4" fill="none" strokeLinecap="round" />
  ...
  johnson: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 40 q4 -1.5 7 0" stroke="#1c1813" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 40 q4 -1.5 7 0" stroke="#1c1813" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <ellipse cx="33" cy="44" rx="6" ry="5" fill="none" stroke="#2b2622" strokeWidth="1.7" />
      <ellipse cx="47" cy="44" rx="6" ry="5" fill="none" stroke="#2b2622" strokeWidth="1.7" />
      <path d="M39 44 h2" stroke="#2b2622" strokeWidth="1.7" />
      <circle cx="33" cy="44" r="1.5" fill="#2b2622" />
      <circle cx="47" cy="44" r="1.5" fill="#2b2622" />
      <path d="M40 45 L40 51 q0 1.3 -2 1.5" stroke="#9c6334" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M36 56 q4 2 8 0" stroke="#7a3344" strokeWidth="1.8" fill="none" strokeLinecap="round" />
    </svg>
  ),
  // ── Architect pool ───────────────────────────────────────────────────────
  babbage: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 36 q4 -2 7 0" stroke="#6f6a61" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M43 36 q4 -2 7 0" stroke="#6f6a61" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="41" r="1.6" fill="#2b2622" />
      <circle cx="46" cy="41" r="1.6" fill="#2b2622" />
      <path d="M40 42 L40 48 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
  ...
  dijkstra: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 39 q4 -2 7 0" stroke="#534c43" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M43 39 q4 -2 7 0" stroke="#534c43" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="43" r="1.6" fill="#2b2622" />
      <circle cx="46" cy="43" r="1.6" fill="#2b2622" />
      <path d="M40 44 L40 50 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
  ...
  hamilton: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 39 q4 -1.5 7 0" stroke="#3a2c20" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 39 q4 -1.5 7 0" stroke="#3a2c20" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <rect x="29" y="40" width="12" height="9" rx="3" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <rect x="44" y="40" width="12" height="9" rx="3" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <path d="M41 44 h3" stroke="#2b2622" strokeWidth="1.8" />
      <circle cx="35" cy="44.5" r="1.5" fill="#2b2622" />
      <circle cx="50" cy="44.5" r="1.5" fill="#2b2622" />
      <path d="M40 45 L40 50 q0 1.2 -2 1.5" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M36 55 q4 2 8 0" stroke="#b5604a" strokeWidth="1.6" fill="none" strokeLinecap="round" />
    </svg>
  ),
  // ── Coder pool ─────────────────────────────────────────────────────────────
  knuth: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M28 38 q4 -2 7 0" stroke="#9a948a" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M45 38 q4 -2 7 0" stroke="#9a948a" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <circle cx="32" cy="42" r="6.5" fill="none" stroke="#23262f" strokeWidth="2" />
      <circle cx="48" cy="42" r="6.5" fill="none" stroke="#23262f" strokeWidth="2" />
      <path d="M38.5 42 h3" stroke="#23262f" strokeWidth="2" />
      <circle cx="32" cy="42.5" r="1.5" fill="#2b2622" />
      <circle cx="48" cy="42.5" r="1.5" fill="#2b2622" />
  ...
  lovelace: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M31 41 q4 -1.5 7 0" stroke="#2e2218" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 41 q4 -1.5 7 0" stroke="#2e2218" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="44" r="1.5" fill="#2b2622" />
      <circle cx="46" cy="44" r="1.5" fill="#2b2622" />
      <path d="M40 45 L40 50 q0 1.3 -2 1.5" stroke="#dca87f" strokeWidth="1.3" fill="none" strokeLinecap="round" />
  ...
  ritchie: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 37 q4 -2 7 0" stroke="#3f3122" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M43 37 q4 -2 7 0" stroke="#3f3122" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="41" r="1.6" fill="#2b2622" />
      <circle cx="46" cy="41" r="1.6" fill="#2b2622" />
  ...
  cerf: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 39 q4 -2 7 0" stroke="#9a948a" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 39 q4 -2 7 0" stroke="#9a948a" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <rect x="28" y="40" width="11" height="8" rx="2" fill="none" stroke="#3a3a40" strokeWidth="1.5" />
      <rect x="41" y="40" width="11" height="8" rx="2" fill="none" stroke="#3a3a40" strokeWidth="1.5" />
      <path d="M39 44 h2" stroke="#3a3a40" strokeWidth="1.5" />
      <circle cx="33" cy="44" r="1.4" fill="#2b2622" />
      <circle cx="47" cy="44" r="1.4" fill="#2b2622" />
  ...
  torvalds: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M28 40 q4 -2 7 0" stroke="#43372a" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M45 40 q4 -2 7 0" stroke="#43372a" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <ellipse cx="33" cy="44" rx="6.5" ry="5.5" fill="none" stroke="#23262f" strokeWidth="2" />
      <ellipse cx="47" cy="44" rx="6.5" ry="5.5" fill="none" stroke="#23262f" strokeWidth="2" />
      <path d="M39 44 h2" stroke="#23262f" strokeWidth="2" />
      <circle cx="33" cy="44.5" r="1.6" fill="#2b2622" />
      <circle cx="47" cy="44.5" r="1.6" fill="#2b2622" />
      <path d="M40 45 L40 51 q0 1.4 -2 1.6" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      <path d="M35 56 q5 2.5 10 0" stroke="#a9603f" strokeWidth="1.6" fill="none" strokeLinecap="round" />
    </svg>
  ),
  perlman: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M31 40 q4 -1.5 6 0" stroke="#34281c" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 40 q4 -1.5 6 0" stroke="#34281c" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="43" r="6" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <circle cx="47" cy="43" r="6" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <path d="M40 43 h1" stroke="#2b2622" strokeWidth="1.8" />
      <circle cx="34" cy="43.5" r="1.5" fill="#2b2622" />
      <circle cx="47" cy="43.5" r="1.5" fill="#2b2622" />
      <path d="M40 44 L40 50 q0 1.2 -2 1.5" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M36 55 q4 2 8 0" stroke="#b5604a" strokeWidth="1.6" fill="none" strokeLinecap="round" />
    </svg>
  ),
  // ── Analyst pool ───────────────────────────────────────────────────────────
  codd: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M29 39 q4 -2 7 0" stroke="#746f66" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M44 39 q4 -2 7 0" stroke="#746f66" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <rect x="28" y="40" width="13" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.9" />
      <rect x="44" y="40" width="13" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.9" />
      <path d="M41 44 h3" stroke="#2b2622" strokeWidth="1.9" />
      <circle cx="34" cy="44.5" r="1.5" fill="#2b2622" />
      <circle cx="50" cy="44.5" r="1.5" fill="#2b2622" />
      <path d="M40 45 L40 51 q0 1.3 -2 1.5" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M36 56 q4 2 8 0" stroke="#a9603f" strokeWidth="1.5" fill="none" strokeLinecap="round" />
    </svg>
  ),
  hopper: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M32 41 q4 -1.5 7 0" stroke="#2e2620" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M42 41 q4 -1.5 7 0" stroke="#2e2620" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <circle cx="35" cy="43" r="1.5" fill="#2b2622" />
      <circle cx="47" cy="43" r="1.5" fill="#2b2622" />
      <path d="M40 44 L40 49 q0 1.3 -2 1.5" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
      <path d="M36 54 q4 2 8 0" stroke="#a9603f" strokeWidth="1.5" fill="none" strokeLinecap="round" />
  ...
  boole: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 37 q4 -2 7 0" stroke="#2a2018" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M43 37 q4 -2 7 0" stroke="#2a2018" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="41" r="1.6" fill="#2b2622" />
      <circle cx="46" cy="41" r="1.6" fill="#2b2622" />
      <path d="M40 42 L40 48 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
  ...
  hoare: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M29 39 q4 -2 7 0" stroke="#b3aea4" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M44 39 q4 -2 7 0" stroke="#b3aea4" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <rect x="28" y="40" width="13" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.9" />
      <rect x="44" y="40" width="13" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.9" />
      <path d="M41 44 h3" stroke="#2b2622" strokeWidth="1.9" />
      <circle cx="34" cy="44.5" r="1.5" fill="#2b2622" />
  ...
  turing: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 39 q4 -2 7 0" stroke="#34281c" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M43 39 q4 -2 7 0" stroke="#34281c" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <circle cx="34" cy="43" r="1.6" fill="#2b2622" />
      <circle cx="46" cy="43" r="1.6" fill="#2b2622" />
      <path d="M40 44 L40 50 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      <path d="M35 55 q5 2.5 10 0" stroke="#a9603f" strokeWidth="1.6" fill="none" strokeLinecap="round" />
  ...
  liskov: (
    <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
      ...
      <path d="M30 41 q4 -1.5 7 0" stroke="#6f6456" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M43 41 q4 -1.5 7 0" stroke="#6f6456" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <rect x="29" y="42" width="12" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <rect x="44" y="42" width="12" height="9" rx="2" fill="none" stroke="#2b2622" strokeWidth="1.8" />
      <path d="M41 46 h3" stroke="#2b2622" strokeWidth="1.8" />
      <circle cx="35" cy="46.5" r="1.5" fill="#2b2622" />
      <circle cx="50" cy="46.5" r="1.5" fill="#2b2622" />
      <path d="M40 47 L40 52 q0 1.2 -2 1.4" stroke="#d89f73" strokeWidth="1.3" fill="none" strokeLinecap="round" />
...
const GENERIC: React.ReactElement = (
  <svg viewBox="0 0 80 96" className="w-full h-full" xmlns={SVG}>
    ...
    <circle cx="34" cy="42" r="1.6" fill="#2b2622" />
    <circle cx="46" cy="42" r="1.6" fill="#2b2622" />
    <path d="M40 43 L40 49 q0 1.5 -2 1.8" stroke="#d89f73" strokeWidth="1.4" fill="none" strokeLinecap="round" />
