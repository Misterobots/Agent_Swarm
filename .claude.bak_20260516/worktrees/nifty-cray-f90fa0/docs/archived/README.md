...
**Do not update these files.** If you need to change something, update the live document in the appropriate location:

| Topic | Current Document |
|-------|-----------------|
| Architecture & Design | [`docs/admin/design_framework.md`](../admin/design_framework.md) |
| Services, Ports, APIs | [`docs/admin/technical_reference.md`](../admin/technical_reference.md) |
| Security & Identity | [`docs/admin/security.md`](../admin/security.md) |
| Troubleshooting | [`docs/admin/troubleshooting.md`](../admin/troubleshooting.md) |
| Master Index | [`docs/INDEX.md`](../INDEX.md) |

## Archive Contents

| File | Was Used For | Superseded By |
|------|-------------|---------------|
| `AGENTIC_HIVE_ARCHITECTURE.md` | v3.1 architecture spec | `admin/design_framework.md` |
| `CONNECTION_REFERENCE.md` | Service URLs and API endpoints | `admin/technical_reference.md` |
| `INFRASTRUCTURE_REFERENCE.md` | Per-service infrastructure details | `admin/technical_reference.md` |
| `governance_walkthrough.md` | Request lifecycle, MAESTRO layers | `admin/design_framework.md` + `admin/security.md` |
| `marsrl_hive_redesign_walkthrough.md` | MarsRL implementation walkthrough | `admin/design_framework.md` |
| `JWT_EPHEMERAL_AGENTS_RESEARCH.md` | JWT-ACE design research | `admin/security.md` |
| `EXPERTISE_TEMPLATE_EVOLUTION.md` | ExpertiseTemplate design | `admin/design_framework.md` |
