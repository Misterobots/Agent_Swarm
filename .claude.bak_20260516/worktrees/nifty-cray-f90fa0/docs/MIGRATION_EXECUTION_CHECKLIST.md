...
|--------|------|----------|
| `execution_plane/docker-compose.yml` | Infrastructure | Lovelace compose (post-migration) |
| `turing_gateway/docker-compose.yml` | Infrastructure | Turing compose (received monitoring services) |
